...
type UserResolver interface {
	...
	Password(ctx context.Context, obj *model.User) (string, error)
	FirstName(ctx context.Context, obj *model.User) (string, error)
	LastName(ctx context.Context, obj *model.User) (string, error)
}
...
func (ec *executionContext) field_Mutation_createUser_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalONewUser2ᚖexampleᚋgraphᚋmodelᚐNewUser(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) unmarshalONewUser2ᚖexampleᚋgraphᚋmodelᚐNewUser(ctx context.Context, v interface{}) (*model.NewUser, error) {
	if v == nil {
		return nil, nil
	}
